import 'package:aninag_citizen/app/router/router_refresh_notifier.dart';
import 'package:aninag_citizen/features/auth/data/auth_providers.dart';
import 'package:aninag_citizen/features/auth/presentation/login_screen.dart';
import 'package:aninag_citizen/features/auth/presentation/profile_screen.dart';
import 'package:aninag_citizen/features/auth/presentation/welcome_screen.dart';
import 'package:aninag_citizen/features/home/presentation/home_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/my_reports_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/new_report/capture_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/new_report/category_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/new_report/review_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/new_report/submitted_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/report_detail_screen.dart';
import 'package:aninag_citizen/features/incident_reporting/presentation/track_by_id_screen.dart';
