...
staging/production:
  ...
  flutter build apk --flavor development -t lib/main_development.dart --dart-define=APP_FLAVOR=development --dart-define=API_BASE_URL=http://10.0.2.2:8080

  flutter build appbundle --flavor development -t lib/main_development.dart --dart-define=APP_FLAVOR=development --dart-define=API_BASE_URL=http://10.0.2.2:8080
...
the host machine directly (no 10.0.2.2 alias needed):
  ...
  flutter run -t lib/main_development.dart --dart-define=APP_FLAVOR=development --dart-define=API_BASE_URL=http://localhost:8080
*/
